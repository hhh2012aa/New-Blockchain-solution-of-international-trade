...
class secondpage():
    ...
    def __init__(self,root,myTitle,flag):    
        ...
        bt_Bargain=tk.Button(win,text="買賣爭議",font=('微軟正黑體 bold',16),fg='gray10',bg='SeaGreen2',command = disputefunc)
        ...
        Myaddr = Label(win,anchor=W,justify='center',bg='orange2',font=('微軟正黑體 bold',12), text = MyaddrText)
        Myaddr.place(x=720,y=30,width=530,height=40,anchor=CENTER)
